...
type AnswerRepository interface {
	...
	GetBaseAnswers(ctx context.Context, userID int, testID int) ([]answerrepo.TaskAnswer, error)
	GetHardAnswersByTest(ctx context.Context, testID int) ([]answerrepo.TaskAnswer, error)
	GetBaseAnswersByTest(ctx context.Context, testID int) ([]answerrepo.TaskAnswer, error)
...
type AnswerCheckService interface {
	Check(studentAnswers []answercheckserv.TaskAnswer, trueAnswers []answercheckserv.TaskAnswer) (answercheckserv.CheckResult, error)
}
